...
// base url
RS.URL = "https://rockingsoccer.com/en/soccer/";
...
// get player info
RS.Player.prototype.getInfo = function(forceRefresh) {
    let playerInfo = null;
    ...
    $(baseContent.children[0]).children().each(function() {
        switch (this.children[0].innerText) {
            ...
            case "Special attributes":
                info.isHardworking = (this.children[1].innerText.indexOf("Hardworking") >= 0);
...
RS.Player.prototype._calculatePropertyGrade = function() {
    ...
    property_score += (info.position === "Keeper") ? 4.4 : info.power;
